...
sbatch $JOB_SCRIPT experiment=ood_eval data=synthetic_and_nsynth detector=none training=param_only model=ks_freqsampling
sbatch $JOB_SCRIPT experiment=ood_eval data=synthetic_and_nsynth detector=none training=param_only model=ks_timedomain
...
echo "✅ All 13 jobs successfully submitted to SLURM!"